...
describe('User config tests', () => {
  ...
  test('should return ID of pikachu', async () => {
    let id = await User.getId('pikachu')
    expect(id).toBeNumber()
    expect(id).toBe(user2)
  })

  test('should return firstname & surname of ID 31', async () => {
    ...
    expect(firstname).toEqual('ikenna')
    expect(surname).toEqual('williams')
  })
})
