...
const sendMailAndcreateDir = async (insertId, username, email, res) => {
  ...
  let url = `http://localhost:${
    ...
    options = {
      to: email,
      subject: 'Activate your Featherfax account',
      html: `<span>Hello ${username},<br>You received this message because you created an account on Featherfax.<span><br><span>Click on the activation button below to activate your account and continue exploring.</span><br><br><a href='${url}' style='border: 1px solid #1b9be9; font-weight: 600; color: #fff; border-radius: 3px; cursor: pointer; outline: none; background: #333333; padding: 4px 15px; display: inline-block; text-decoration: none;'>Activate</a><br> <span>or, copy and paste the url below into your browser to activate your account manually. <br>url: ${url}</span>`,
    }
