...
// Story routes
const storyR = require('./routes/api/story/story-routes'),
    getStoryR = require('./routes/api/story/get-stories'),
    seenR = require('./routes/api/story/seen-routes')
